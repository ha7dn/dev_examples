...
{
    /// <summary>
    /// CLASE DE MANEJO DE ERRORES EN CASO DE HABER FALLOS
    /// </summary>
    public class ErrorHandling
    {
        ...
        string ErrorTable;
        string ErrorOrigin;
        string ErrorLogPath = AppDomain.CurrentDomain.BaseDirectory + @"\Log.txt";
        ...
        void EnviarEmailError()
        {
            ...
            mail.Subject = "Error EnviarEmailError - " + pagina;
        ...
        void InsertError()
        {
            ErrorQuery = "INSERT INTO [dbo].[LogErrores] ([Procedencia] ,[Mensaje] ,[FechaCreacion]) VALUES ('" + Environment.StackTrace + ",'" + ErrorMsg + "')";
            try
            {
        ...
        void WriteErrorLog()
        {
            ...
            try
            {
                ...
                sb.AppendLine(dateTime + " - Error:" + ErrorMsg);
